...
import com.example.concung.view.adapter.ProductWatchedAdapter
...
class ProductLoveFragment : Fragment(), InterfaceClick.EventProduct {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        activity!!.supportActionBar!!.title = resources.getString(R.string.txt_product_love)
    ...
    private fun getProduct() {
        ...
        homeViewModel!!.getProductLove().observe(this, Observer { list ->
            if (list.isNotEmpty()) {
