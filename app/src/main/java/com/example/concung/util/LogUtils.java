...
import com.example.concung.BuildConfig;
    ...
    public static void d(String className, String methodName, String message) {
        if (isPrintLog) {
            ...
            for(int i = 0; i <= message.length() / maxLogSize; i++) {
                ...
                Log.d("Activity " + className, methodName + ": " + message.substring(start, end));
            }
    ...
    public static void api(String className,Call call,Object src) {
        if (isPrintLog) {
            ...
            for(int i = 0; i <= message.length() / maxLogSize; i++) {
                ...
                Log.e("API " + className, message.substring(start, end));
            }
        }
    }
